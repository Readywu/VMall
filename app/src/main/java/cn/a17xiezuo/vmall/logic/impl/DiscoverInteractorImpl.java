...
import cn.a17xiezuo.vmall.entity.MoreExplore;
import cn.a17xiezuo.vmall.entity.Person;
import cn.a17xiezuo.vmall.entity.Scenario;
 ...
 */
public class DiscoverInteractorImpl implements IDiscoverInteractor {


    private static final String TAG = DiscoverInteractorImpl.class.getSimpleName();

    private VolleyManager volleyManager;

    public DiscoverInteractorImpl() {
        this.volleyManager = VolleyManager.getInstance(VMallApplication.getInstance().getApplicationContext());
    }

    @Override
    public void getPersonInfo(Context context, final OnFetchDiscoverDataFinishedListener listener) {
    ...
    @Override
    public void getHomeData(Context context, final OnFetchDiscoverDataFinishedListener listener) {
        ...
        volleyManager.jsonObjectRequest(httpRequest, new IHttpListener<JSONObject>() {
            ...
            public void onSuccess(JSONObject response) {
                ...
                listener.onFetchDiscoverDataSuccess(datum1);
            }
