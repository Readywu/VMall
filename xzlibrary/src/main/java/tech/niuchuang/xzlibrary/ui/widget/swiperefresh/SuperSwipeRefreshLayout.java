...
package tech.niuchuang.xzlibrary.ui.widget.swiperefresh;
...
/**
 * Created by yeh on 15-12-11.
 * <p>
 * 支持下拉刷新和上拉加载更多
 * <p>
 * 非侵入式，对原来的ListView、RecyclerView没有任何影响,用法和SwipeRefreshLayout类似
 * <p>
 * 可自定义头部View的样式，调用setHeaderView方法即可 可自定义页尾View的样式，调用setFooterView方法即可
 * <p>
 ...
 * <p>
 * 回调方法更多,比如：onRefresh() onPullDistance(int distance)和onPullEnable(boolean
 * enable)
 * <p>
 * 开发人员可以根据下拉过程中distance的值做一系列动画
 */
public class SuperSwipeRefreshLayout extends ViewGroup {
    private static final String LOG_TAG = SuperSwipeRefreshLayout.class
            .getSimpleName();
        ...
        public void applyTransformation(float interpolatedTime,
            ...
            if (!mUsingCustomStart) {
                endTarget = (int) (mSpinnerFinalOffset
                        - Math.abs(mOriginalOffsetTop));
            } else {
                endTarget = (int) mSpinnerFinalOffset;
            }
            targetTop = (mFrom
                    + (int) ((endTarget - mFrom) * interpolatedTime));
            ...
            if (mRefreshing) {
                ...
                if (mScale) {
                    ...
                    setTargetOffsetTopAndBottom(
                            mOriginalOffsetTop - mCurrentTargetOffsetTop, true);
                }
            }
    ...
    public SuperSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        mMediumAnimationDuration = getResources()
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mHeadViewContainer.measure(
                MeasureSpec.makeMeasureSpec(mHeaderViewWidth,
                        MeasureSpec.EXACTLY),
                MeasureSpec.makeMeasureSpec(3 * mHeaderViewHeight,
                        MeasureSpec.EXACTLY));
        mFooterViewContainer.measure(
                MeasureSpec.makeMeasureSpec(mFooterViewWidth,
                        MeasureSpec.EXACTLY),
                MeasureSpec.makeMeasureSpec(mFooterViewHeight,
                        MeasureSpec.EXACTLY));
    ...
    public boolean isChildScrollToBottom() {
        ...
        if (mTarget instanceof RecyclerView) {
            ...
            if (fristPos == 0 && absListView.getChildAt(0)
    ...
    private void moveToStart(float interpolatedTime) {
        int targetTop = 0;
        targetTop = (mFrom
                + (int) ((mOriginalOffsetTop - mFrom) * interpolatedTime));
        int offset = targetTop - mHeadViewContainer.getTop();
        setTargetOffsetTopAndBottom(offset, false /* requires update */);
    }
        ...
        mScaleDownToStartAnimation = new Animation() {
            ...
            public void applyTransformation(float interpolatedTime,
                ...
                float targetScale = (mStartingScale
                        + (-mStartingScale * interpolatedTime));
    ...
    public class OnPushLoadMoreListenerAdapter
            implements OnPushLoadMoreListener {
    ...
    public class CircleProgressView extends View implements Runnable {
        ...
        private RectF getBgRect() {
            ...
            if (bgRect == null) {
                ...
                bgRect = new RectF(offset, offset, width - offset,
                        height - offset);
            }
            return bgRect;
        }
        ...
        private RectF getOvalRect() {
            ...
            if (ovalRect == null) {
                ...
                ovalRect = new RectF(offset, offset, width - offset,
                        height - offset);
            }
            return ovalRect;
        }
