 ...
 * </p>
 */
public class ImSwipeRefreshLayout extends ViewGroup {
    private static final String LOG_TAG = ImSwipeRefreshLayout.class
            .getSimpleName();
    ...
    private boolean mRefreshEnable = true; // 刷新效果不可见，刷新功能无效
    private boolean mRefreshVisiable = true; // 刷新效果可见性，刷新功能有效
    ...
    private final Animation mAnimateToStartPosition = new Animation() {
        ...
        public void applyTransformation(float interpolatedTime,
            ...
            if (mFrom != mOriginalOffsetTop) {
                targetTop = (mFrom + (int) ((mOriginalOffsetTop - mFrom)
                        * interpolatedTime));
            }
     ...
     * @param context
     */
    public ImSwipeRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public ImSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void draw(Canvas canvas) {
        super.draw(canvas);
        if (mRefreshEnable && mRefreshVisiable)
    ...
    public void setRefreshVisiable(boolean refreshVisiable) {
        mRefreshVisiable = refreshVisiable;
    }
}
