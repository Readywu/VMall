 ...
 * 所有的扩展请求必须继承这个类{@link tech.niuchuang.xzlibrary.net.request.RequestWrapper}，
...
public abstract class RequestWrapper<T> extends com.android.volley.Request<T> {
     ...
     * 结果
     */
    protected IHttpListener<T> mHttpListener;

    public RequestWrapper(HttpRequest httpRequest, IHttpListener<T> listener) {
        // 这里不需要错误的监听，下面已经做了处理
